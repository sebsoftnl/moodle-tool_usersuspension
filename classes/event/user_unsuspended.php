...
/**
 * this file contains the event for user unsuspension
 *
 * File         unsuspended.php
 * Encoding     UTF-8
...
/**
 * tool_usersuspension\event\user_unsuspended
 *
...
class user_unsuspended extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' unsuspended the user with id '$this->objectid'.";
    }
