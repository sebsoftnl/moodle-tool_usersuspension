...
$string['setting:uploadfilename'] = 'Upload bestandsnaam';
...
$string['config:fromfolder:disabled'] = 'Gebruikersschorsing optie \'opschoning van gebruikers\' is uitgezet via de globale blokinstellingen';
